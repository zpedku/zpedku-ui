  ...
  <div>
    <el-carousel :interval="4000" type="card" height="450px">
      <el-carousel-item class="carousel-item-intro">
        <h2>项目介绍</h2>
        <ul>
          <li>前端使用vue、emelemt-UI</li>
          <li>感谢kitty ui</li>
          <li>测试vue页面</li>
        </ul>
        <!--<div><img src="@/assets/wiff/媚3.jpg" style="width: 200px;" /></div>-->
      </el-carousel-item>
      ...
      <el-carousel-item class="carousel-item-func">
        ...
        <!--<div><img src="@/assets/wiff/媚1.jpg" style="width: 200px;" /></div>-->
      </el-carousel-item>

      <el-carousel-item class="carousel-item-env">
        <h2>开发环境</h2>
        <ul>
          <li>IDE : idea 2018。     JDK : JDK 1.8.x。</li>
          <li>Maven : Maven 3.5.x。   MySQL: MySQL 5.7.x。</li>
          <li>IDE : VS Code 1.27。    Webpack：webpack 4..x。</li>
        ...
        <!--<div><img src="@/assets/wiff/媚2.jpg" style="width: 200px;" /></div>-->
      </el-carousel-item>
